...
<div style="text-align: center; padding: 4rem 2rem; background: linear-gradient(135deg, #7a9b76 0%, #5a7a56 100%); color: white; margin-bottom: 3rem;">
  ...
  <a href="/what-is-biotech/" class="btn btn--primary btn--x-large" style="background: white; color: #7a9b76; font-weight: bold;">Get Started</a>
</div>

<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; margin: 3rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
  
  <div>
    <h2 style="color: #7a9b76;">What is BioBridge?</h2>
  ...
  <div>
    <h2 style="color: #7a9b76;">The Problem</h2>
...
<div style="max-width: 1000px; margin: 3rem auto; padding: 2rem; background: #faf9f7; border-radius: 10px;">
  ...
  <div style="display: grid; grid-template-columns: 200px 1fr; gap: 2rem; align-items: start;">
    ...
    <div>
      <img src="/assets/images/profile-photo.jpg" alt="Profile Photo" style="width: 100%; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    </div>
...
<div style="text-align: center; margin: 4rem 0;">
  <a href="/what-is-biotech/" class="btn btn--success btn--x-large">Get Started</a>
</div>
