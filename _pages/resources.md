...
<header class="bb-page-header">
  <span class="eyebrow">Curated Science Media</span>
  <h1>The Learning Lab</h1>
  <p class="bb-page-header__deck">Media and resources for exploring biotech: newsletters, podcasts, videos, courses, and books, all hand-picked for quality and accessibility.</p>
</header>
